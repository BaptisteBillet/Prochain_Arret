...
Shader "GABI/matObject_basic" {
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform sampler2D _node_964; uniform float4 _node_964_ST;
            struct VertexInput {
...
/////// Diffuse:
                ...
                float4 _node_964_var = tex2D(_node_964,TRANSFORM_TEX(i.uv0, _node_964));
                float3 diffuseColor = _node_964_var.rgb;
